...
const Card = ({ desc, name, profession, image }) => {
    return (
        <div className="p-6 flex flex-col justify-between gap-7  shadow-[0_4px_54px_0_rgba(0,0,0,0.05)] rounded-3xl hover:scale-102 hover:shadow-lg cursor-pointer transition-all duration-200">
            <div className="flex gap-4 flex-col">
                <Icons icon="RATING_ICON" />
