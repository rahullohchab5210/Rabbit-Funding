            ...
            <div className='max-w-285 mx-auto  px-3' >
                <div className='flex flex-row max-lg:flex-wrap items-center justify-between max-lg:justify-center pt-35 pb-22.5 max-lg:gap-y-10' >
                    <div className='max-w-122.5 max-lg:max-w-full max-lg:text-center max-lg:flex max-lg:flex-col max-lg:items-center ' >
                        ...
                        <p className='pt-4 pb-8 text-body text-[#4E4E4E] font-normal leading-[150%] tracking-[0%] max-w-112.5' >We’re not a software company pretending to care. We’re real underwriters — with real decision-making power — using tech to move faster, not think for us.</p>
                        <Button className="flex items-center gap-[10.98px] bg-[#7AC943] border-none text-white hover:bg-black transition-all duration-300"
